            ...
            <div class="card-body p-0">
                ...
                <div class="col-lg-6">
                    ...
                    <form class="user" method="POST" action="{{ route('login') }}">
                        ...
                        <input type="text" class="form-control form-control-user @error('email') is-invalid @enderror" value="{{ old('email') }}" name="email" id="email" aria-describedby="emailHelp" placeholder="Enter Username or Email Address..." required autofocus autocomplete="email">
                        @error('email')
