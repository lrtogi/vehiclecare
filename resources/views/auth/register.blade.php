                        ...
                        <div class="p-5">
                            ...
                            <form class="user" action="{{ route('register') }}" method="post">
                                ...
                                <div class="form-group">
                                    <input value="{{ old('company_name') }}" type="text"
                                        ...
                                        autocomplete="company_name" required autofocus />
                                    @error('name')
                                ...
                                <div class="form-group">
                                    <input value="{{ old('full_name') }}" type="text"
                                        class="form-control form-control-user @error('full_name') is-invalid @enderror"
                                        name="full_name" id="full_name" placeholder="Your Full Name"
                                ...
                                <div class="form-group">
                                    <input value="{{ old('no_telp_company') }}" type="text"
                                        class="form-control form-control-user is_numeric @error('no_telp_company') is-invalid @enderror"
                                        name="no_telp_company" id="no_telp_company" placeholder="No Telepon Perusahaan"
                                        value="{{ old('no_telp_company') }}" required />
                                    @error('no_telp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    <input value="{{ old('no_telp') }}" type="text"
                                        class="form-control form-control-user is_numeric @error('no_telp') is-invalid @enderror"
                                        name="no_telp" id="no_telp" placeholder="No Telepon" value="{{ old('no_telp') }}"
                                        required />
                                    @error('no_telp')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                ...
                                <div class="form-group">
                                    <input value="{{ old('alamat') }}" type="text"
                                        ...
                                        placeholder="Alamat / Lokasi perusahaan" required />
                                    @error('alamat')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
